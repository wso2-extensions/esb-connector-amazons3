...
public class S3OperationResult {
     ...
     */
    private JsonObject resultElement;
    ...
    public S3OperationResult(String operation, boolean isSuccessful, JsonObject resultElement) {
        this.operation = operation;
        this.isSuccessful = isSuccessful;
    ...
    public JsonObject getResultElement() {
