...
public class ConnectorIntegrationUtil {
	...
	public static int sendRequestViaSingleProxy(String addUrl, String query,
			String contentType, Map<String,String> parametersMap) throws IOException, JSONException {

		String charset = "UTF-8";
		URLConnection connection = new URL(addUrl).openConnection();
		connection.setDoOutput(true);
		connection.setRequestProperty("Action", parametersMap.get("Action"));
		connection.setRequestProperty("Accept-Charset", charset);
...
//		connection.setRequestProperty("Keep-Alive", "false");
	...
	public static String getResponseViaSingleProxy(String addUrl, String query,
            String contentType, Map<String,String> parametersMap) throws IOException, JSONException {
